...
Command: npx gltfjsx@6.2.7 constantine.glb
*/

import React, { useRef } from 'react'
import { useGLTF } from '@react-three/drei'

export function Constantine(props) {
  const { nodes, materials } = useGLTF('/constantine/constantine.glb')
  return (
...
useGLTF.preload('/constantine/constantine.glb')
